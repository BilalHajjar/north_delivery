...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  List<Map<String, dynamic>> myMapTitleAndDescription = [
    ...
    {'title': 'توصيل سريع وآمن لجميع احتياجاتك', 'description': 'من خلال شبكتنا الواسعة، نضمن لك وصول طلباتك بسرعة وأمان، أينما كنت وفي أي وقت تشاء'},
    {'title': 'توصيل مجاني لكل احتياجاتك', 'description': 'اطلب ما تحتاجه من طعام، مستلزمات يومية، أو أي منتجات أخرى، واستمتع بخدمة التوصيل المجاني إلى باب منزلك دون أي تكلفة إضافية.'}
  ];
List<Widget> images=[];
  @override
  void initState() {
